      ...
      <main id="main">
        ...
        <section className="story-section wrap" aria-labelledby="story-title">
          ...
          <div className="story-copy">
            ...
            <p><cite>Antifragile</cite> is my favorite book because its central idea mirrors how I want to build: do not merely survive volatility—improve because of it. Alongside Black Swan thinking, it shapes how I construct and operate every business. I plan for rare, consequential shocks, limit irreversible downside, and preserve enough optionality to respond when assumptions change.</p>
